import { useDeleteTodo } from "../ApiServices/todoServices/useDeleteTodo";
import { useGetTodos } from "../ApiServices/todoServices/useGetTodos";
import styled from "styled-components";
import { useUpdateTodo } from "../ApiServices/todoServices/useUpdateTodo";
...
function ListTodos() {
    ...
    function handleChecked(todo) {
        ...
        updateTodo({ id: todo._id, updatedTodoObj });
    }
